...
donate: רק יוזמת מסירה מפורשת של השולח. לכל אדם כמה פניות; מסירה חדשה פותחת פנייה חדשה גם אם קיימת פנייה מתואמת. לפני בחירה בפנייה קיימת השתמש במספר מפורש או selected_request_id. אם לא ברור איזו פנייה, next.
...
PHOTO FIRST: מוסר ללא מקבל מסוים — קודם תמונה. לפני תמונה מותר לשמור רק פריט, טלפון מוסר ואישור יוזמת המסירה; אל תחלץ שם, כתובת, קומה, פירוק או עובדות אחרות.
...
אם משתמש מסר כמה פרטים מותרים בהודעה אחת, כלול פקודות נפרדות באותה תוכנית. אין לעקוף PHOTO FIRST באמצעות כמה פקודות באותה תוכנית.`;
