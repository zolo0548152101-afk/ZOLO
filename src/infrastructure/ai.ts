...
אם משתמש מסר כמה פרטים מותרים בהודעה אחת, כלול פקודות נפרדות באותה תוכנית. אם נשאל 'האם יש מקבל מסוים?' והמשתמש עונה 'לא', 'אין מקבל' או 'אין לי מקבל', סמן שאין מקבל מסוים והמשך בלי לחזור על אותה שאלה.`;
