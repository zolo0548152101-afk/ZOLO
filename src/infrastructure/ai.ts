...
תמונה: תמונה מומלצת, אך אינה תנאי להמשך שיחה או לאיסוף פרטים. מוסר ללא מקבל מסוים יכול להמשיך למסור פרטי פריט, חינם/תקין ופרטי מיקום גם בלי תמונה; אפשר לבקש תמונה בהמשך לפני פרסום הפריט או התאמה. אם המוסר אומר שיש מקבל מסוים, אין לעכב את השיחה בגלל תמונה — ממשיכים באיסוף ואישור שני הצדדים. אין להציג תמונה כאילו התקבלה אם לא נשלחה.
...
אם משתמש מסר כמה פרטים מותרים בהודעה אחת, כלול פקודות נפרדות באותה תוכנית.`;
